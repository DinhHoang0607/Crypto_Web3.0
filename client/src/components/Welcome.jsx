...
const Input = ({
	...
	<input
		...
		outline-none bg-transparent text-white border-none
					...
					items-center blue-glassmorphism'>
						...
						{false ? (
							...
							<button
								...
								className='text-white w-full mt-2 border-[1px] rounded-full p-2 cursor-pointer border-[#3d4f7c] hover:border-[#2952e3]'>
								Send Now
							</button>
						)}
					</div>
